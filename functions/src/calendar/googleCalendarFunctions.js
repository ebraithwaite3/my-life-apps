...
// Helper to strip timezone offset from ISO string (e.g., '2025-11-14T10:00:00Z' -> '2025-11-14T10:00:00')
...
exports.writeToCalendar = onRequest(async (req, res) => {
  try {
    const { title, startTime, endTime, description, location, reminderMinutes } = req.body.data || req.body;
...
exports.updateCalendarEvent = onRequest(async (req, res) => {
  try {
    const { eventId, title, description, startTime, endTime, location, reminderMinutes } = req.body.data || req.body;
